...
def get_batch_on_this_tp_rank(data_iterator):
    ...
    # print("tp:{} dp:{} pp:{}".format(mpu.get_tensor_model_parallel_rank(), mpu.get_data_parallel_rank(), mpu.get_pipeline_model_parallel_rank()))
    def _broadcast(item):
    ...
    if mpu.get_tensor_model_parallel_rank() == 0:
       ...
       if data_iterator is not None:
           ...
           data = None
       while data['tokens'].shape[0] != args.batch_distribution[mpu.get_data_parallel_rank()]:
           data = next(data_iterator)
       batch = {
    ...
    #    print("pp:{} token_size:{} label_size:{}".format(mpu.get_pipeline_model_parallel_rank(), batch['tokens'].shape, batch['labels'].shape), args.batch_distribution)
