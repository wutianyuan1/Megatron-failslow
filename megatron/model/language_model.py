...
class TransformerLanguageModel(MegatronModule):
    ...
    def forward(self, enc_input_ids, enc_position_ids, enc_attn_mask,
        ...
        # Run encoder.
        # if enc_hidden_states != None:
            # print("dp:{} pip:rank:{} enc:{} enc_hid_size:{}".format(mpu.get_data_parallel_rank(), mpu.get_pipeline_model_parallel_rank(), enc_hidden_states, enc_hidden_states.shape))
            # if enc_hidden_states.shape[1] == 16:
            #     exit(0)
