    ...
    def __init__(self, config,
        ...
        if config.virtual_pipeline_model_parallel_size is not None:
            ...
            if args.model_type == ModelType.encoder_and_decoder and \
                ...
                #     self.num_layers = args.num_layers - (mpu.get_pipeline_model_parallel_world_size() - 1) * (self.num_layers + 7)
                # else:
                #     self.num_layers += 7
                # print("rank:{} layers:{}".format(mpu.get_pipeline_model_parallel_rank(), self.num_layers))
                # exit(0)
