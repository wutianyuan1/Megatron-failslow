...
def loss_func(loss_mask: torch.Tensor, output_tensor: torch.Tensor):
    ...
    # print("losses:{} loss_mask:{}".format(losses.shape, loss_mask.shape))
    ...
    # print("rank:{} bsz:{} loss:{} ouput_shape:{}".format(rank, bsz, loss, output_tensor.shape))
    # if loss < 5:
    #     exit(0)
...
def forward_step(data_iterator, model: GPTModel):
    ...
    tokens, labels, loss_mask, attention_mask, position_ids = get_batch(
        data_iterator)
    # print("rank:{} token_size:{}".format(mpu.get_tensor_model_parallel_rank(), tokens.shape))
